...
import { GitForkIcon, GitPullRequest, Link2Icon, Loader2, Lock, LockKeyholeOpenIcon, Star, } from "lucide-react";
...
export default function Home(){   
  ...
  return (
    <DashboardLayout title={"Found Issues"}>  
      <FadeInSlide>
                  ...
                  <FadeInSlide>
                    <div className="flex flex-row justify-between items-start gap-4"> 
                      <h1 className="text-4xl font-semibold mb-4">
                        ...
                        <br /> 
                        <div className="font-normal text-sm text-gray-500 flex-wrap flex mt-2">
                    ...
                    <div className="h-full">
                      ...
                      <div className="flex-1 rounded-xl h-fit bg-muted/50 aspect-video mt-5"> 
